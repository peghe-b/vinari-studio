...
| QR windshield card (VINARI+) | "შუშაზე ნომრის დატოვება არ მინდა, მაგრამ უნდა დამიკავშირდნენ." · "გზა გადამიკეტეს." | A4 black and white; the passer-by picks 1 of 3 reasons; **the plate is nowhere on the card**; silent 23:00–07:00; revoked with one tap and never opens again | H11, H04 (Notification), H09 (QRCard) | use the three reasons verbatim from `../web/c/index.html` (as v3 does) |
